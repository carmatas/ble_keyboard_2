...
__attribute__((unused)) static const uint8_t char_prop_notify = ESP_GATT_CHAR_PROP_BIT_NOTIFY;
...
__attribute__((unused)) static const uint8_t char_prop_read_write_notify = ESP_GATT_CHAR_PROP_BIT_READ|ESP_GATT_CHAR_PROP_BIT_WRITE|ESP_GATT_CHAR_PROP_BIT_NOTIFY;
